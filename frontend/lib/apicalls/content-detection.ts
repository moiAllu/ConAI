...
export const getUserContentDetections = async (userId: string) => {
  return fetch(
    `${BACKEND_API_URL}/api/content-detection/detections/${userId}`,
    {
      method: "GET",
      credentials: "include",
      headers: {
...
export const getContentDetectionById = async (userId: string, id: string) => {
  return fetch(
    `${BACKEND_API_URL}/api/content-detection/detection/${userId}/${id}`,
    {
      method: "GET",
      credentials: "include",
      headers: {
...
export const createContentDetection = async (
  userId: string,
  method: string,
  content: string,
