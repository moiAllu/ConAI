export const getUserRewritesHistory = async (userId: string) => {
  return fetch(
    `${process.env.NEXT_PUBLIC_CONAI_BACKEND_URL}/api/rewrite/rewrites/${userId}`,
    {
      method: "GET",
      credentials: "include",
      headers: {
...
export const getUserRewriteById = async (rewriteId: string, userId: string) => {
  return fetch(
    `${process.env.NEXT_PUBLIC_CONAI_BACKEND_URL}/api/rewrite/${rewriteId}/${userId}`,
    {
      method: "GET",
      credentials: "include",
      headers: {
...
export const deleteRewriteById = async (rewriteId: string, userId: string) => {
  return fetch(
    `${process.env.NEXT_PUBLIC_CONAI_BACKEND_URL}/api/rewrite/${rewriteId}/${userId}`,
    {
      method: "DELETE",
