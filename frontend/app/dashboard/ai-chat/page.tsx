    ...
    <div className="p-2 flex flex-col w-full h-full max-h-[1080px]">
      ...
      <div className="w-full h-full justify-evenly flex-col flex">
        <div className="w-full h-full flex-col">
          <div className="justify-center flex flex-grow flex-col p-6 items-center">
          ...
          <div className="w-full justify-center flex min-w-lg ">
            <Card className="grid grid-cols-2 gap-2 p-5 items-center w-[90%]  border-none">
              <Card className="">
                <CardHeader>
        ...
        <div className="w-full justify-center flex min-w-lg">
          <Card className="flex flex-col p-5 items-center w-[90%] space-y-2 ">
            ...
            <div className="flex justify-between w-full items-center">
              <div className=" flex items-start w-full text-gray-600 space-x-2">
                <Button
                  variant="ghost"
                  size="sm"
