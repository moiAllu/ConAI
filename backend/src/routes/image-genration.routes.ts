import {
  ...
  downloadGeneratedImageById,
} from "../controllers/image-generation.controller";
...
router.get(
  "/image-generation/images/:userId",
  validateRoute,
  getGeneratedImageHistory
);
...
router.delete("/image/:id/:userId", validateRoute, deleteGeneratedImageById);
router.get(
  "/image/download/:imageId/:resolution",
  validateRoute,
  downloadGeneratedImageById
);
